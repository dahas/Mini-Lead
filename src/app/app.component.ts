...
export class AppComponent extends AudioComponent {
  ...
  keyOn(hz: number): void {
    ...
    //   this.osc2 = this.createOscillator(t, this.valOsc2Wave, frequencies[0], this.valOsc2Tune);
    ...
    //   this.osc3 = this.createOscillator(t, this.valOsc3Wave, frequencies[0], this.valOsc3Tune);
    ...
    //   this.osc4 = this.createOscillator(t, this.valOsc4Wave, frequencies[0], this.valOsc4Tune);
